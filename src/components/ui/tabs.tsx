...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-full shadow-lg bg-[#050505]  text-[#C1C1C1] border-2 border-[#232323] p-2',
      className,
    )}
    {...props}
  />
